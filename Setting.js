...
global.owner = process.env.OWNER_NUMBER  || '923418437337' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"S♥︎Z",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '20_03_2024_SIGMA_MD_gC59mmSe_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'ZARSHE',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `SHEHANSHAH`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ZARSHE',      // ADD YOUR STICKER AUTHOR NAME
